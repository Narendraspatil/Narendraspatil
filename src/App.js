              ...
              {[
                {
                  ...
                  problemStatement: "Manual daily reporting processes consumed significant time and were prone to human error. The team spent 60+ minutes daily on data extraction, transformation, and report generation, impacting productivity and delaying decision-making.",
                  objectives: [
                    "Automate end-to-end reporting workflow from data extraction to delivery",
                    "Reduce processing time by at least 80%",
                    "Eliminate manual errors and ensure data consistency"
                  ],
                  methodology: [
                    {
                      title: "1. Process Analysis",
                      description: "Mapped existing manual workflow and identified automation opportunities"
                    },
                    {
                      title: "2. Script Development",
                      description: "Built Python scripts for data extraction, transformation, and formatting"
                    },
                    {
                      title: "3. Scheduling Setup",
                      description: "Implemented automated job scheduling with error handling and notifications"
                    },
                    {
                      title: "4. Testing & Deployment",
                      description: "Conducted parallel runs and validated output accuracy before full deployment"
                    }
                  ],
                  codeSnippet: `# Automated Report Generation
import pandas as pd
...
def generate_daily_report():
    ...
    html_report = summary.to_html(index=False)
...
schedule.every().day.at("08:00").do(generate_daily_report)`,
                  insights: [
                    "Processing time reduced from 60 minutes to 3-5 minutes (92% improvement)",
                    "Zero data entry errors since automation implementation",
                    "Reports now delivered consistently at 8 AM daily, improving planning cycles",
                    "System processes 50,000+ records daily with 99.8% reliability"
                  ],
                  recommendations: [
                    "Extend automation to weekly and monthly reports for additional time savings",
                    "Implement dashboard integration for real-time data access",
                    "Add predictive alerts for anomaly detection in daily metrics",
                    "Create self-service report builder for ad-hoc analysis needs"
                  ],
                  conclusion: "The automated reporting system delivered immediate ROI, saving 250+ hours annually while improving accuracy and reliability. The success has led to automation of additional workflows across the organization.",
                  link: "#"
                },
                {
                  ...
                  problemStatement: "Manual CRM data management led to inconsistent lead assignments, data quality issues, and compliance risks. Teams needed purpose-built tools to enforce business rules and streamline workflows.",
                  objectives: [
                    "Build lead assignment tool with rule-based distribution logic",
                    "Create data validation system to ensure CRM data quality",
                    "Develop compliance checking tool for regulatory requirements"
                  ],
                  methodology: [
                    {
                      title: "1. Requirements Gathering",
                      description: "Conducted stakeholder interviews to understand pain points and business rules"
                    },
                    {
                      title: "2. Tool Development",
                      description: "Built web-based utilities using Apps Script and React framework"
                    },
                    {
                      title: "3. Database Integration",
                      description: "Connected tools to CRM database with secure API authentication"
                    },
                    {
                      title: "4. User Training & Rollout",
                      description: "Created documentation and trained teams on new tools"
                    }
                  ],
                  insights: [
                    "Lead assignment time reduced from 15-20 minutes to under 2 minutes per batch",
                    "Data validation caught 150+ errors monthly that would have caused downstream issues",
                    "Compliance tool achieved 100% audit success rate across 6 monthly audits",
                    "User adoption reached 95% within first month of deployment"
                  ],
                  recommendations: [
                    "Add machine learning for intelligent lead scoring and routing",
                    "Implement real-time validation with immediate user feedback",
                    "Create mobile-responsive versions for field team access",
                    "Build analytics dashboard to track tool usage and ROI metrics"
                  ],
                  conclusion: "Internal CRM tools significantly improved operational efficiency and data quality. The modular architecture allows easy addition of new utilities based on evolving business needs.",
                  link: "#"
                },
                {
                  ...
                  problemStatement: "Team task management was fragmented across emails, spreadsheets, and chat messages. There was no centralized system to track assignments, deadlines, and dependencies with proper hierarchy and permissions.",
                  objectives: [
                    "Create centralized task management system with calendar integration",
                    "Implement role-based access control and approval workflows",
                    "Build automated reminders and escalation mechanisms"
                  ],
                  methodology: [
                    {
                      title: "1. System Design",
                      description: "Designed data structure and user interface for task management"
                    },
                    {
                      title: "2. Apps Script Development",
                      description: "Built backend logic for task assignment, tracking, and notifications"
                    },
                    {
                      title: "3. Calendar Integration",
                      description: "Connected to Google Calendar for deadline visibility"
                    },
                    {
                      title: "4. Permission System",
                      description: "Implemented hierarchy-based access and approval workflows"
                    }
                  ],
                  codeSnippet: `// Task Assignment with Notification
function assignTask(taskId, assignee, deadline) {
  var sheet = SpreadsheetApp.getActiveSpreadsheet()
    .getSheetByName('Tasks');
  
  // Update task assignment
  sheet.getRange(taskId, 3).setValue(assignee);
  sheet.getRange(taskId, 4).setValue(deadline);
  ...
  MailApp.sendEmail({
    ...
    body: 'You have been assigned: ' + taskName
                  ...
                  insights: [
                    "Task completion rate improved from 68% to 89% with calendar integration",
                    "Average task resolution time decreased by 35% due to better visibility",
                    "Automated reminders reduced missed deadlines by 72%",
                    "Management gained real-time visibility into team workload and capacity"
                  ],
                  recommendations: [
                    "Add task dependency tracking to identify bottlenecks",
                    "Implement workload balancing algorithms for optimal distribution",
                    "Create team performance analytics and burndown charts",
                    "Integrate with project management tools for enterprise scalability"
                  ],
                  conclusion: "The task scheduler prototype demonstrated significant value in improving team coordination and accountability. Success has led to discussions about enterprise-level task management system deployment.",
                  link: "#"
                }
              ].map((project, i) => (
                <ProjectCard key={i} project={project} delay={0.1 * (i + 1)} />
